...
const PROGRAM_ERRORS: Record<string, Record<number, string>> = {
  ...
  poi_system: {
    ...
    6022: 'Invalid interaction for this POI type',
    6023: 'No POI interaction is currently active',
    6024: 'No active shop to reroll',
    6025: 'No items available for the selected criteria',
    6026: 'Invalid offer context',
    6027: 'Player is not on the POI tile',
    6028: 'Invalid session account',
  },
};
