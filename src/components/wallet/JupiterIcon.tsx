...
export function JupiterIcon({ size = 28, color = '#333333' }: JupiterIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 800 800" fill="none">
      <Circle cx="400" cy="400" r="360" stroke={color} strokeWidth={40} />
      <Path
        d="M536 568.9c-66.8-108.5-166.4-170-289.4-195.6-43.5-9-87.2-8.9-129.4 7.7-28.9 11.4-33.3 23.4-19.7 53.7 92.4-21.9 178.4-1.5 258.9 45 81.1 46.9 141.6 112.2 169.1 205 38.6-11.8 43.6-18.3 34.3-54.2-5.7-21-12.6-43-24-61.6Z"
        fill={color}
      />
      <Path
      ...
      />
      <Path
        d="M709.8 325.3c-47-178.9-238-265-379.2-221.4C482.7 133.9 607.5 206.4 709.8 325.3Z"
        fill={color}
      />
      <Path
        d="M155.4 583.9c54.6 69.3 124 109.7 213 122.8C334.4 643.2 214.6 574.5 155.4 583.9Z"
        fill={color}
      />
    </Svg>
  );
