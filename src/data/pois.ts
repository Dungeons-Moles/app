...
export const POI_DEFINITIONS: Record<POIId, POIDefinition> = {
  ...
  L1: {
    ...
    name: 'Mole Den',
    emoji: '🏠',
    image: require('../../assets/world/pois/mole-den.png'),
    rarity: 'FIXED',
    interaction: 'REST',
    nightOnly: true,
  ...
  L2: {
    ...
    name: 'Supply Cache',
    emoji: '📦',
    image: require('../../assets/world/pois/supply-cache.png'),
    rarity: 'COMMON',
  ...
  L3: {
    ...
    name: 'Tool Crate',
    emoji: '🧰',
    image: require('../../assets/world/pois/tool-crate.png'),
    rarity: 'UNCOMMON',
    interaction: 'ITEM_SELECTION',
  ...
  L5: {
    ...
    name: 'Rest Alcove',
    emoji: '🕯️',
    image: require('../../assets/world/pois/rest-alcove.png'),
    rarity: 'COMMON',
    interaction: 'REST',
    nightOnly: true,
  ...
  L6: {
    ...
    name: 'Survey Beacon',
    emoji: '📡',
    image: require('../../assets/world/pois/survey-beacon.png'),
    rarity: 'COMMON',
    interaction: 'REVEAL',
  ...
  L7: {
    ...
    emoji: '📍',
    image: require('../../assets/world/pois/seismic-scanner.png'),
    rarity: 'UNCOMMON',
    interaction: 'REVEAL',
  ...
  L8: {
    ...
    name: 'Rail Waypoint',
    emoji: '🚇',
    image: require('../../assets/world/pois/rail-waypoint.png'),
    rarity: 'UNCOMMON',
  ...
  L11: {
    ...
    name: 'Rune Kiln',
    emoji: '🏺',
    image: require('../../assets/world/pois/rune-kiln.png'),
    rarity: 'RARE',
    interaction: 'FUSE',
  ...
  L12: {
    ...
    name: 'Geode Vault',
    emoji: '💠',
    image: require('../../assets/world/pois/geode-vault.png'),
    rarity: 'RARE',
    interaction: 'ITEM_SELECTION',
  ...
  L13: {
    ...
    name: 'Counter Cache',
    emoji: '🎯',
    image: require('../../assets/world/pois/counter-cache.png'),
    rarity: 'UNCOMMON',
    interaction: 'ITEM_SELECTION',
